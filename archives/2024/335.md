...
updated_at: '2026-07-01 02:11:46'
labels:
  - 生活随笔
  - '2024'
---
...
> Recent Activity 已被移除 ["Recent Activity" gone from home page?](https://github.com/orgs/community/discussions/176449#discussioncomment-15238388)
...
为了方便，我会用 Raycast 创建 [Quicklink](https://manual.raycast.com/quicklinks) 指令以快速搜索。

> `https://github.com/issues?q=is%3Aissue+involves%3Atofrankie {argument}`

如果使用 Alfred，则参考 [Features/Web Search](https://www.alfredapp.com/help/features/web-search/) 创建指令。
