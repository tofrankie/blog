...
updated_at: '2026-01-01 21:04:58'
labels:
  - 小程序
  - '2019'
---
...
代码片段：[canvas demo](https://developers.weixin.qq.com/s/14RxPjmC7k50)

再放个采坑过程：`关于 HTML → Canvas → Image → 保存相册` 的过程。[点我跳转](https://juejin.im/post/5a17c5e26fb9a04527254689)。（不是我写的，但过程跟我相同，懒得写了）

▼ 效果图
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767272677684.png)
