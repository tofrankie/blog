...
updated_at: '2026-07-19 22:50:33'
labels:
  - Editor
  - '2020'
---
...
```json
{
  ...
  "workbench.colorCustomizations": {
    "[Vitesse Dark]": {
      ...
      "list.hoverBackground": "#4773f615",
      "list.activeSelectionBackground": "#4774f666",
      "list.inactiveSelectionBackground": "#4774f631",
      "quickInputList.focusBackground": "#4773f615", // 命令面板选中背景色
      "terminal.selectionBackground": "#4774f6b3", // 终端选中背景色
    },
  },
}
```

> 由于 Vitesse Dark 默认的选中背景色特别弱，因此调整了一下编辑器和终端模块的颜色。[vitesse-dark.json](https://github.com/antfu/vscode-theme-vitesse/blob/main/themes/vitesse-dark.json)

> 前不久 Cursor 2.x 某版本支持 Markdown 的预览模式，它对应的选中背景色为 `list.activeSelectionBackground`。这也会影响一些导航列表的选中、悬浮颜色。

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/3/1773933719255.png)
...
> Markdown Preview Enhanced 主题美化：[markdown-preview-gfm](https://github.com/tofrankie/markdown-preview-gfm)
