...
updated_at: '2026-01-29 03:49:39'
labels:
  - Node.js
  - '2022'
---
...
目前我同时使用着 nvm、npm、yarn classic、pnpm，一些个人建议（仅供参考）：
...
- `~/.npm`（传统安装和 nvm 安装的 Node.js 都是该目录）
- `~/Library/Caches/Yarn/v6`
- `~/Library/pnpm/store/v10`

全局依赖目录：

- `/usr/local/lib/node_modules`（传统安装的 Node.js）
- `~/.nvm/versions/node/vX.X.X/lib/node_modules`（使用 nvm 安装的 Node.js）
