...
updated_at: '2026-05-09 03:34:41'
labels:
  - Node.js
  - '2022'
---
...
> [!NOTE]
> 从设计上看，使用 fnm 或 nvm 切换 Node.js 版本时，只有 npm 全局包能做到隔离效果（npm 有 prefix 的机制），而 yarn 或 pnpm 不同 Node.js 版本下安装全局依赖都会落到同一个存储目录，也就是说在 Node 22 安装的 pnpm 全局依赖 A，切换到 Node 22 也能直接使用全局依赖 A。因此，建议尽量少地使用全局依赖，使用时应确保 Node.js 版本正确。
