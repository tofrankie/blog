...
updated_at: '2026-01-04 13:49:25'
labels:
  - 编码规范
  - JS
  - '2021'
...
对于有强迫症的我，还要继承 [CSScomb](https://github.com/csscomb/csscomb.js)，去对 CSS 进行排序。示例：[tofrankie/csscomb-mini](https://github.com/tofrankie/csscomb-mini)
