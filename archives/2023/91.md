...
updated_at: '2026-01-23 23:31:48'
labels:
  - Node.js
  - '2021'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767511436516.jpg)

此前介绍了 [nrm](https://github.com/tofrankie/blog/issues/89) 用于快速切换 NPM 镜像源。
...
> 但是这个有点不爽，就是它只会切换 npm 命令的镜像源，无法修改 yarn 的。

最近发现了一个 [i5ting/yrm](https://github.com/i5ting/yrm)（YARN registry manager）工具，可以同步修改 npm 和 yarn 镜像源，它本身也是 nrm 的一个 Fork 分支。
