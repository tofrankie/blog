...
updated_at: '2026-01-01 17:05:43'
labels:
  - Mac
  - Paralles Desktop
  - '2021'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767257941721.jpg)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767257988822.png)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767258004797.png)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767258024167.png)

然后返回 Windows 预览体验计划界面，可能仍提示不支持 Windows 11 的更新...

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767258039047.png)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767258069787.png)

原因是在 PD 偏好设置中，我对这台虚拟机分配了 2G 的内存。由于修改内存需要对虚拟机关机才能修改，因此建议提前改一下。（准备升级之后再改回来）

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767258110617.png)

按要求设置 4G 内存即可。如果升级过程中才发现也没问题，关掉虚拟机重新设置下，再开机进行更新即可。

还有一步操作，在虚拟机的配置中加上 **TPM 芯片**选项，这是在其他帖子的教程看到的，当初添加了但也是没办法升级 Win11 的。（可能这个步骤也不重要吧）

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767258122698.png)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767258162257.png)

不要慌，此时前往 `文件资源管理器 -> 此电脑 -> 本地磁盘(C:) -> $WINDOWS.~BT -> Sources` 目录下，找到 `AppraiserRes.dll` 文件并删除。其中 `$WINDOWS.~BT` 属于隐藏性文件。

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767258179061.png)

返回更新界面，继续进行更新...

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767258192331.png)

此处省略一万字......下载安装完成，重启中...

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767258230919.png)

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767258251516.png)

## 四、更新后

更新成功了，在 UI 颜值上确实有了长足的提升...简单体验下来，略有点小卡...

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767258276243.png)

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767258292536.png)

某个 Moment 不小心打开**电脑健康状况检查**发现，竟然又行了，哈哈。

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767258307894.png)
