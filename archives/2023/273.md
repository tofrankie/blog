...
updated_at: '2025-12-25 21:06:43'
labels:
  - 前端
  - JS
  - '2021'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2025/12/1766655615285.jpg)
...
> 对于事件监听器的兼容性，可看 [JavaScript 事件详解](https://github.com/tofrankie/blog/issues/264)。
...
在 React 的路由系统中，修改路由、监听路由实际上是由 [ReactTraining/react-history](https://github.com/ReactTraining/react-history) 库中 `createBrowserHistory()` 或 `createHashHistory()` 方法所构造的 `history` 对象（有别于 `window.history` 对象）去操作的。
