...
updated_at: '2026-01-04 13:30:38'
labels:
  - 前端
  - JS
  - '2021'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767503714746.png)

在 JavaScript 中，`this` 是一个很重要的关键字。此前写过一篇文章：[this 详解](https://github.com/tofrankie/blog/issues/236)。本文内容主要介绍事件处理函数中如何使用 `this` 的几种方法及区别。

> 注意，本文示例均在**非严格模式**下运作。而严格模式下，某些场景对 this 会有一些约束，具体可看这篇[文章](https://github.com/tofrankie/blog/issues/232)。
