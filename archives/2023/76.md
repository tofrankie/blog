...
updated_at: '2026-01-03 20:59:30'
labels:
  - Webpack
  - '2020'
---
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767445097567.png)
▲ 图片源自“卤蛋实验室”文章
...
简单来说：`module`、`chunk` 和 `bundle` 其实就是同一份代码在不同转换场景取的三个名称。我们编写的是 `module`，webpack 处理时是 `chunk`，最终生成供浏览器允许的是 `bundle`。
