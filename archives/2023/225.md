...
updated_at: '2026-01-03 22:12:52'
labels:
  - 尚未完结
  - JS
  - '2020'
...
最近在写 React 系列文章，其中写到 Redux 的时候（[这里](https://github.com/tofrankie/blog/issues/62)），提到了一个叫做 `compose` 的高阶函数， 它里面用到的就是 [Array.prototype.reduce](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/Reduce) 方法。它的源码如下：
