...
updated_at: '2026-01-04 15:22:50'
labels:
  - Node.js
  - '2020'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767511040134.jpeg)
...
通常，本人在项目中使用得更多的是 [yarn classic](https://classic.yarnpkg.com/en/docs)。管理镜像源推荐使用 `nrm` 或 `yrm`，可以快速切换镜像源。前者仅会修改 `npm` 镜像源，后者会同时修改 `npm` 和 `yarn` 镜像源。
