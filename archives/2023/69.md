...
updated_at: '2026-01-03 21:26:02'
labels:
  - Webpack
  - '2020'
---
...
> 如果你在技术选型中使用了 `webpack-dev-middleware` 而没有使用 `webpack-dev-server`，请使用 [`webpack-hot-middleware`](https://github.com/webpack-contrib/webpack-hot-middleware) package，以在你的自定义 server 或应用程序上启用 HMR。webpack-dev-server 在内部使用了 webpack-dev-middleware
