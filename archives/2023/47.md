...
updated_at: '2026-05-09 02:15:01'
labels:
  - Mac
  - Editor
  - Terminal
  - '2022'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767255257592.jpg)

## 一、背景

不知道什么时候起，我那服役了 5 年多的 MacBook Pro，每次重启后立刻唤醒 VS Code 的时候，总会弹出提示：

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767255276256.png)
...
* 命令行启动 `code path/to/project`
* 点击应用图标

上述问题，仅在非命令行启动才会出现。也就是说，使用命令行启动就是解决问题的方式之一。但通过点击应用图标启动的也不少，比如我是常驻在 Dock 栏的。
...
* [fnm](https://github.com/Schniz/fnm)：使用 Rust 写的，还没用就感觉到快了，哈哈
