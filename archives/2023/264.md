...
updated_at: '2026-01-01 01:44:47'
labels:
  - JS
  - '2021'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767202961566.jpg)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767202993382.png)
...
前面提到，所有事件对象都源自 [Event](https://developer.mozilla.org/zh-CN/docs/Web/API/Event) 基类，意味着 Event 基类（对象）本身包含适用于所有事件类型实例的属性和方法。主要是为了兼容性。
