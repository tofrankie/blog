...
updated_at: '2026-01-12 17:53:06'
labels:
  - JS
  - '2021'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767454234466.jpg)
...
▼ Chrome 92
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767454269929.png)

▼ Safari 14.1.2
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767454277149.png)

**对比发现，不同浏览器下运行结果竟然不一样，Why?**

* 当下最新版 Chrome 浏览器打印结果为：`a、c、d、b、e`。
* 当下最新版 Safari 浏览器打印结果为：`a、c、d、e、b`。
