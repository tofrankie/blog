...
updated_at: '2026-01-01 16:48:19'
labels:
  - Mac
  - Terminal
  - '2022'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767256952830.jpg)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767256977243.png)

细心的同学会发现，关于 HostName 命令行输出与界面上显示的不一样，具体原因下面会介绍。

<!--
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767257028014.png)
-->
...
1. 从 `/etc/hosts` 文件读取（在 OS X Yosemite 之前为 `/etc/hostconfig` 文件）。
