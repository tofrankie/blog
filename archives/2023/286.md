...
updated_at: '2026-01-01 03:51:08'
labels:
  - 尚未完结
  - JS
  - '2022'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767210446437.jpeg)
...
当生成器「未开始执行之前」或者「执行结束之后」，调用生成器的 `throw()` 方法。它的异常只会被生成器函数外部的 `try...catch` 捕获到。若外部没有 `try...catch` 语句，则会报错且代码就会停止执行。[详看](https://github.com/tofrankie/blog/issues/258)
