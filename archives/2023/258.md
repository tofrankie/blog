...
updated_at: '2026-01-03 23:39:24'
labels:
  - JS
  - '2021'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767454566833.jpg)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767454625760.png)
...
2. 次调用`next()`方法时，再继续往下执行，直到遇到下一个 `yield` 表达式。
