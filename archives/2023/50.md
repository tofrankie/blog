...
updated_at: '2026-01-03 18:02:47'
labels:
  - TS
  - 前端
  - '2020'
---
[上一篇](https://github.com/tofrankie/blog/issues/49)介绍了 TypeScript 的原始数据类型，本文介绍一下任意值。
...
[下一篇](https://github.com/tofrankie/blog/issues/51)介绍 TypeScript 之类型推论。
