...
updated_at: '2026-01-03 23:35:43'
labels:
  - JS
  - '2021'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767454352442.jpg)
...
此前[另一篇文章](https://github.com/tofrankie/blog/issues/253)提到过，可以 `async` 函数结合 `for` 循环、`try...catch` 可以实现多次重复尝试的效果。
...
它可能得不到预期结果，在[另一篇文章](https://github.com/tofrankie/blog/issues/254)也详细地分析过了。
...
> 如果对 Generator 函数不熟悉的话，建议先看下这篇文章：[细读 ES6 之 Generator 生成器](https://github.com/tofrankie/blog/issues/258)，再回来看本节内容。
