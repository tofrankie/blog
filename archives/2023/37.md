...
updated_at: '2026-01-01 21:25:06'
labels:
  - Linux
  - '2022'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767273812565.jpeg)

在上一篇文章 [Linux 链接文件详解](https://github.com/tofrankie/blog/issues/36)中提到了 inode 信息。在 inode 的中包含三种文件时间戳：`mtime`、`atime`、`ctime`。
