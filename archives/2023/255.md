...
updated_at: '2026-01-04 12:59:55'
labels:
  - JS
  - '2021'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767502441569.jpg)
...
>
> 所以，那个经典的面试题就是，包括 `setTimeout`、`Promise` 等，然后问输出顺序是什么？本质就是考察 JavaScript 的事件循环机制（Event Loop）嘛。可以看下这篇文章：[通过两个例子再探 Event Loop](https://github.com/tofrankie/blog/issues/348)。
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767502603509.png)

当 `p1` 状态为 `rejected` 时，`p2` 状态如图：

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767502614386.png)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767502650754.png)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767502672566.png)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767502696007.png)
...
[下一篇](https://github.com/tofrankie/blog/issues/256)接着介绍 `Promise.all()`、`Promise.race()` 等。
