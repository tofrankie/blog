...
updated_at: '2026-01-02 03:42:56'
labels:
  - Node.js
  - '2022'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767296265179.jpg)
...
> [官方文档](https://nodejs.org/api/path.html#pathresolvepaths)
...
> [官方文档](https://nodejs.org/api/path.html#pathjoinpaths)
...
有人可能会问，[`path.normalize()`](https://nodejs.org/api/path.html#pathnormalizepath) 又是干嘛的呢？
