...
updated_at: '2026-01-02 04:42:15'
labels:
  - Node.js
  - '2021'
---
![配图源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767300027600.jpg)
...
> 比如，在本地使用 [Verdaccio](https://github.com/tofrankie/blog/issues/90) 搭建一个私有分发平台，可用 `nrm add local http://localhost:4873/` 来添加源。
