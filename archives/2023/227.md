...
updated_at: '2026-01-03 21:31:30'
labels:
  - 前端
  - 代码片段
  - JS
...
2. 关于顶级域名、二级域名、三级域名等划分如理解有偏差，自行搜索。[参考](https://www.zhihu.com/question/29998374/answer/399176525)
3. 当前采用部分 ES6 语法，若需兼容 ES5 自行修改即可。
4. 还有一些比较实用的 JS [方法](https://github.com/tofrankie/utils)，比如中文转拼音、身份证号码校验等。
