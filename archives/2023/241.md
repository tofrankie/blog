...
updated_at: '2026-01-04 15:51:32'
labels:
  - JS
  - '2021'
---
...
在另外一篇文章《[JS 数据类型详解](https://github.com/tofrankie/blog/issues/239)》中讲述 `ToPrimitive` 和 `OrdinaryToPrimitive` 操作时，涉及到这两方法，所以今天来简单写一下。
...
> 关于 [OrdinaryToPrimitive(O, hint)](https://262.ecma-international.org/#sec-ordinarytoprimitive) 的介绍可以看[文章](https://github.com/tofrankie/blog/issues/239)。
...
> 更多详见 [JS 数据类型详解 — 对象的内部属性](https://github.com/tofrankie/blog/issues/239)章节
