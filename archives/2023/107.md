...
labels:
  ...
  - '2022'
---
![图片源自 Freepik](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767416038158.jpeg)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767416246925.png)

以上都没问题！接着，我们试着 Push 一下：

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767416265149.png)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767416288982.png)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767416312317.png)
...
> **请注意，`origin` 只是一个别名，用于指向远程仓库。这个别名是可以自行修改的，比如命名为 `foo`、`bar` 等。使用别名好处是「方便」。**
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767416390414.png)

然后，我们修改下远程名称为 `foo`，也是可以的：

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767416405342.png)

接着，我们随意修改个文件 Push 一下，是这样的 `git push foo main`：

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767416431259.png)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767416462693.png)
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767416482094.png)
...
**若无特殊需求，不要为了个性去更改 `origin`、`upstream` 等被广泛使用的别名，其中所表示的约定俗成的、众所周知的含义。**
...
<!--
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767416607598.png)
-->
...
![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767416749497.png)

接着，我们从 `main` 分支切换至 `dev` 分支。

![](https://cdn.jsdelivr.net/gh/tofrankie/blog@main/images/2026/1/1767416763863.png)
