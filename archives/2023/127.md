...
updated_at: '2026-01-03 17:49:31'
labels:
  - 编码规范
  - '2021'
---
...
由于一元 `++` 和 `--` 运算符都受[自动插入分号机制](https://github.com/tofrankie/blog/issues/223)（Automatic Semicolon Insertion，简称 ASI）的影响，因此空格的差异可能会改变源代码的语义。
