...
updated_at: '2026-01-04 16:54:50'
labels:
  - Mac
  - 持续更新
  - '2022'
...
- [Raycast](https://raycast.com/?via=73820f)，一个比 Alfred 更好用的启动器。
...
- ~~[ClashX](https://github.com/yichengchen/clashX)，你懂的~~（作者已删库）。（[备用网站](https://clashx.org/clashx-official/)）
