...
updated_at: '2026-01-03 18:11:45'
labels:
  - 手写系列
  - '2022'
---
...
不作过多介绍，如果对这俩兄弟不太了解的，可看文章[数据类型详解](https://github.com/tofrankie/blog/issues/239)。
...
因此，使用 `instanceof` 来判断是否为数组是不准确的，可看[文章](https://github.com/tofrankie/blog/issues/230)。
