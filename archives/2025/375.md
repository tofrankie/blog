...
updated_at: '2025-11-14 10:13:57'
labels:
  - '2025'
  - Node.js
  - Paralles Desktop
...
2. 项目位于 Parallels Desktop 的共享目录（UNC 路径），Parallels 的 psf 文件系统不完全兼容 Windows 的权限系统。使用 PS Z:\Web\Git\raycast-wechat-devtool> 替代 \\psf\Home\Web\Git\raycast-wechat-devtool。因为 
