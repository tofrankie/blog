...
updated_at: '2026-09-19 20:30:05'
labels:
  - '2025'
  - Tools
---
...
如果你用过 Alfred，还没有用过 [Raycast](https://raycast.com/?via=tofrankie)，不妨试试，其免费订阅也足够好用（[Raycast vs Alfred](https://www.raycast.com/raycast-vs-alfred?via=tofrankie)）。
...
于是产生了开发一个 Raycast 扩展的想法，以支持 Confluence 和 Jira 的快速搜索以及部分简单操作。恰好公司私有部署版本（Data Center）也支持以 Personal Access Token 的方式进行身份认证，这是一种安全的认证方式以便于与外部程序集成。[了解更多](https://confluence.atlassian.com/enterprise/using-personal-access-tokens-1026032365.html)

## 开始之前

安装 Raycast 后，前往 Raycast Store 安装 [**Atlassian Data Center (Self-Hosted)**](https://raycast.com/tofrankie/atlassian-data-center?via=tofrankie) 扩展。
...
[更多截图](https://www.raycast.com/tofrankie/atlassian-data-center?via=tofrankie)

## 其他

个人常用的一些 Raycast 扩展，但不一定适合你，按需食用：

- [Lark Documents](https://www.raycast.com/tmk/lark?via=tofrankie) - 搜索飞书文档
- [Cursor](https://www.raycast.com/degouville/cursor-recent-projects?via=tofrankie) - 常用 Search Recent Projects
- [WeChat DevTool](https://www.raycast.com/tofrankie/wechat-devtool?via=tofrankie) - 启动小程序
- [DeepWiki](https://www.raycast.com/vivek/deepwiki?via=tofrankie) - 了解一些库内部实现问答可能更快
