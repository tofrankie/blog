...
updated_at: '2026-09-19 20:28:58'
labels:
  - '2025'
  - Tools
---
...
以后者为例，可以将项目名称、项目路径、项目名称拼音（若有中文）添加到 keywords 字段，参考 [pinyin.ts](https://github.com/tofrankie/raycast-wechat-devtool/blob/2be07dadbc747826def1a1c5373bb0040d4d004b/src/utils/pinyin.ts)。
