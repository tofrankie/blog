...
updated_at: '2026-04-30 10:48:24'
labels:
  - React
  - 前端
  - '2025'
...
> 为什么是确定性的？
> 
> 首先，此前 ECMA-262 规范未指定对象枚举顺序，具体取决于 JS 引擎实现，事实是大部分浏览器都是基于插入的顺序。
>
> 其次，最新的 ECMA-262 规范中以明确规定了遍历的顺序。[OrdinaryOwnPropertyKeys(obj)](https://tc39.es/ecma262/#sec-ordinaryownpropertykeys)
>
> 了解更多细节请看此[回答](https://www.zhihu.com/question/23494408/answer/374191529)。
